...
public class US350Tests {
	...
	public void setUp() {
		...
		u2 = c1.getUsersContainer().createUser("Joaquim", "joaquim@gmail.com", "123", "Empregado", "940000000",
				"Rua Maria", "4444-444", "221234567", "Porto", "Portugal");
		u3 = c1.getUsersContainer().createUser("Maria", "maria@gmail.com", "123", "Empregado", "930000000",
				"Rua Maria", "4444-444", "221234567", "Porto", "Portugal");

		u4 = c1.getUsersContainer().createUser("Leonor", "leonor@gmail.com", "123", "Empregado", "930000000",
				"Rua Maria", "4444-444", "221234567", "Porto", "Portugal");

		u5 = c1.getUsersContainer().createUser("Raquel", "raquel@gmail.com", "123", "Empregado", "930000000",
				"Rua Maria", "4444-444", "221234567", "Porto", "Portugal");
