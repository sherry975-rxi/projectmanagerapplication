...
public class ApplicationTest {
	...
	public void ensureXMLElementExportToStringIsValid() throws Exception {
		String expected = "<application>" + getLineBreak() + "<description>MyApplication</description>" + getLineBreak()
				+ "<keywords>" + getLineBreak() + "<keyword>" + getLineBreak() + "<value>Doors</value>" + getLineBreak()
				+ "</keyword>" + getLineBreak() + "<keyword>" + getLineBreak() + "<value>Windows</value>"
				+ getLineBreak() + "</keyword>" + getLineBreak() + "</keywords>" + getLineBreak() + "</application>"
				+ getLineBreak();
