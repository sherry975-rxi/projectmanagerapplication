...
public class UserTest {
    ...
    public void testGetAddress() {
        ...
        User u1 = new User("Daniel", "daniel@gmail.com", "01", "Porteiro", "910000000");
        Address a1 = new Address("Rua B", "3700-243", "Porto", "Porto", "Portugal");
        Address a2 = new Address("Rua B", "3700-243", "Porto", "Porto", "Portugal");
        u1.addAddress(a1);
        u1.addAddress(a2);
    ...
    public void testSetAddress() {
        ...
        Address a1 = new Address("Rua A", "3700-243", "Porto", "Porto", "Portugal");
        Address a2 = new Address("Rua A", "3700-243", "Porto", "Porto", "Portugal");
