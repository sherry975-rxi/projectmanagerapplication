...
public class US203FindPendingTasksTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(userRepository.findByUserID(mike.getDBid())).thenReturn(mike);
    ...
    */
    ...
    public void us203UnitTest() {
        ...
        String mikeID = String.valueOf(mike.getDBid());
    ...
    public void us203UnitTestInvalidInputs() {
        ...
        String ownerID = String.valueOf(owner.getDBid());
        Mockito.when(userRepository.findByUserID(owner.getDBid())).thenReturn(owner);
