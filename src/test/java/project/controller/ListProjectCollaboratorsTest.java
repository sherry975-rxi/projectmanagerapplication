...
public class ListProjectCollaboratorsTest {
	...
	public void setUp() {
		...
		usersController.addNewUser("Daniel", "daniel@gmail.com", "001", "Porteiro", "920000000", "MuhPass",
				"Testy Street", "2401-343", "Testburg", "Testo", "Testistan");
		usersController.addNewUser("DanielM", "danielM@gmail.com", "002", "Code Monkey", "920000000", "MuhPass",
				"Testy Street", "2401-343", "Testburg", "Testo", "Testistan");
		usersController.addNewUser("Manel", "user2@gmail.com", "001", "Empregado", "930000000", "MuhPass",
				"Testy Street", "2401-343", "Testburg", "Testo", "Testistan");
		usersController.addNewUser("Manelinho", "user3@gmail.com", "002", "Telefonista", "940000000", "MuhPass",
				"Testy Street", "2401-343", "Testburg", "Testo", "Testistan");

		userManager = Critical.getUsersRepository().getAllUsersFromRepository().get(0);
		user2 = Critical.getUsersRepository().getAllUsersFromRepository().get(1);
