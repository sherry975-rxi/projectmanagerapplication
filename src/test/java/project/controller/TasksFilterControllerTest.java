...
public class TasksFilterControllerTest {
	...
	public void setUp() {
		...
		// create a Date before to the previous Dead line created in order to result in an expired Task
		...
		// associate Task Collaborators to task (info project collaborator + period he was in the task)
