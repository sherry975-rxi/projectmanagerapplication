...
public class UpdateUserInfoController_Test {
	...
	/**
	 * This test checks that address1 is not in user's address list and then add this address with controller.
	 * Last assertTrue checks if the address1 is in  user's address list.
	 */
	@Test
