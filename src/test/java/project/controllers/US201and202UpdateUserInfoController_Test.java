...
public class US201and202UpdateUserInfoController_Test {
	 ...
	 * this address with controllers. Last assertTrue checks if the address1 is in
	 * user's address list.
	 */
	@Test
	...
	public void getAllAddressesTest() {
		...
		// controllers.addNewAddress(u1, address2);

		// assertTrue(address1.equals(controllers.getAllAddresses(u1).get(0)));
		// assertTrue(address2.equals(controllers.getAllAddresses(u1).get(1)));
	...
	/**
	 * This tests the get methods of the controllers
	 */
	@Test
	...
	public void searchUserAddress() {
		...
		/*
		 * Checks if the method in the controllers returns null when it doesn't find a
		 * street;
		 */
	...
	/**
	 * Tests the creator of an address in controllers
	 */
	@Test
	public void testCreateNewAddress() {
		// create a new address in user u1
		address2 = u1.createAddress("Testy Street2", "2401-342", "Testburg2", "Testo2", "Testistan2");
		// create an identical address in controllers
