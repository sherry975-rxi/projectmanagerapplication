...
public class US206CancelRemovalTaskRequestControllerTest {
	...
	public void testCreateRequest() {
		...
		// projectID = 1)
		us206v2Controller.setProjectID(projectA.getDbId());
		us206v2Controller.setTaskID(projectA.getDbId() + ".1");

		// checks the change in task ID
		assertEquals(us206v2Controller.getTaskID(), projectA.getDbId() + ".1");
	...
	public void testGetUnfinishedTaskFromUser() {
		...
		String taskIDandDescription1 = "[" + projectA.getDbId() + ".1] Implementar US100";
		String taskIDandDescription2 = "[" + projectA.getDbId() + ".2] Implementar US200";
