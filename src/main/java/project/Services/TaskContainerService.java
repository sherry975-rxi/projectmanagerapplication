...
public class TaskContainerService {
	...
	// */
	// public List<Task>
	// getUnfinishedTasksFromProjectCollaborator(ProjectCollaborator collab) {
	//
	...
	// */
	// public List<Task>
	// getStartedNotFinishedTasksFromProjectCollaborator(ProjectCollaborator collab)
	// {
	//
	...
	// */
	// public List<Task> getFinishedTaskListofUserInProject(ProjectCollaborator
	// collab) {
	//
	...
	// * given user. Given a negative â€œmonthsAgoâ€� input, Returns ALL finished
	// tasks of
	// * said user
	// *
	// * @param collab
	...
	// */
	// public List<Task>
	// getFinishedTasksFromProjectCollaboratorInGivenMonth(ProjectCollaborator
	// collab, int monthsAgo) {
	// Calendar givenMonth = Calendar.getInstance();
	...
	// } else if (other.getFinishDate().get(Calendar.MONTH) ==
	// givenMonth.get(Calendar.MONTH)) {
	// lastMonthFinishedTaskList.add(other);
	// }
	// }
	// }
	...
	// * @param task
	// * to check
	// * @return TRUE if task exists in the task list FALSE if task does not exist
	// in
	// * the task list
	// */
	...
	// */
	// public double
	// getTimeSpentByProjectCollaboratorInAllTasksLastMonth(ProjectCollaborator
	// collab) {
	// List<Task> lastMonth = new ArrayList<>();
	// lastMonth.addAll(this.getFinishedTasksFromProjectCollaboratorInGivenMonth(collab,
	// 1));
	// double totalTime = 0;
	...
	// */
	// public List<Task> getAllTasksFromProjectCollaborator(ProjectCollaborator
	// collab) {
	...
	// * its team is empty.
	// *
	// * @return listOfTasksWithoutCollaboratorsAssigned List with all the tasks
	// with
	...
	// /**
	// * This method returns a list with the tasks of a certain user by decreasing
	// * order of date. First, this method creates a list which is a copy of the
	// task
	// * list of the user. This method just reverses the initial order of the
	// * TaskList. It does not runs a cycle to compare the tasks finish dates,
	// neither
	// * analysis the TaskList in any way.
	// *
	// * @param toSort
	...
	// * project using method getFinishedTasks. At last, apply the sort by
	// decreasing
	...
	// other.getTaskDeadline().before(today)) {
