...
public class RestRequestController {
     ...
     */
    @PreAuthorize("hasRole('ROLE_COLLABORATOR') and principal.id==@projectService.getProjectById(#projectId).projectManager.userID or hasRole('ROLE_ADMIN')")
     ...
     * @return ResponseEntity
     */
    @PreAuthorize("hasRole('ROLE_COLLABORATOR') and @projectService.isUserActiveInProject(@userService.getUserByEmail(principal.username),@projectService.getProjectById(#projectId)) " +
            "or hasRole('ROLE_COLLABORATOR') and principal.id==@projectService.getProjectById(#projectId).projectManager.userID or hasRole('ROLE_ADMIN')")
     ...
     * @return ResponseEntity
     */
    @PreAuthorize("hasRole('ROLE_COLLABORATOR') and @projectService.isUserActiveInProject(@userService.getUserByEmail(principal.username),@projectService.getProjectById(#projectId)) or hasRole('ROLE_ADMIN')")
