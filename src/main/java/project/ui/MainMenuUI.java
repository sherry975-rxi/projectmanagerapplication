...
public class MainMenuUI {
	...
	public static void main(String[] args) {
		...
		task1 = project1.getTaskRepository().createTask("descriptiondescriptiondescriptiondescriptiondescription", 10, estimatedTaskStartDate, taskDeadline, 1000);
		task2 = project1.getTaskRepository().createTask("DESCRIPTIONDESCRIPTIONDESCRIPTIONDESCRIPTIONDESCRIPTIONDESCRIPTION", 10, estimatedTaskStartDate, taskDeadline, 1000);
