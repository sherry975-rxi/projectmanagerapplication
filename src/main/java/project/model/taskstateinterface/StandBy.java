...
public class StandBy implements TaskStateInterface {
	...
	/**
	 * Method that checks if a task that is currently in the standBy state meets the conditions to change to the onGoing state,
	 * cancelled state or finished state
	 *
	 * @param task to check if it has the conditions to change to the onGoing state, cancelled state or finished state
	 * @param task
	 */
	@Override
	...
	/**
	 * Method that checks if a certain task meets the conditions to be in the StandBy state
	 *
