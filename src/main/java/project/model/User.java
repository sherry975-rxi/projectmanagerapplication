...
public class User implements Serializable {
     ...
     * @param function Function of the new user in the company.
     * @param phone    Phone number of the new user.systemUserStateActive
     */
     ...
     *
     * @param name Name to be set as the new name of the user.
     */
     ...
     *
     * @param phone Phone number that will be set as the new phone number of the user.
     */
     ...
     *
     * @param function Function of the user in the company.
     */
     ...
     *
     * @param userProfile Profile that will be set as the user profile.
    ...
    /**
     * Get project Collaborator list
     *
     * @return project Collaborator list
     */
    ...
    /**
     * set new projectCollaborators list
     *
     * @param projectCollaborators
     */
    public void setProjectCollaborators(List<ProjectCollaborator> projectCollaborators) {
