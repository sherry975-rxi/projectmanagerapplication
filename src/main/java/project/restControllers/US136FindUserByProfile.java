...
public class US136FindUserByProfile {
    ...
    List<String> searchUsersByProfileController(@PathVariable String profileNameToSearch) {
    ...
    private String userDataToString(User toConvert) {
        ...
        return " | id: " + toConvert.getIdNumber() + " | " + profile + " | " + toConvert.getName() + " (" + toConvert.getEmail()
